...
chainsDb.insert_to_c_kw("The chairman of China", "Chinese Government", 0.823)
...
chainsDb.insert_to_c_kw("Warlord and the penultimate Chancellor of the Eastern Han dynasty", "Warfare", 0.931)
chainsDb.insert_to_c_kw("Warlord and the penultimate Chancellor of the Eastern Han dynasty", "Horses", 0.891)
chainsDb.insert_to_c_kw("Warlord and the penultimate Chancellor of the Eastern Han dynasty", "Chinese Government", 0.991)
...
chainsDb.insert_to_c_kw("Poet acclaimed from his own day to the present as a genius", "Curtural Revolution", 0.731)
chainsDb.insert_to_c_kw("Famous teacher, editor, politician", "China", 0.639)
chainsDb.insert_to_c_kw("Famous teacher, editor, politician", "Chinese Government", 0.991)
chainsDb.insert_to_c_kw("Famous teacher, editor, politician", "Curtural Revolution", 0.591)
chainsDb.insert_to_c_kw("Legendary woman warrior from the Southern and Northern Dynasties", "Warfare", 0.791)
